    ...
    <>
      ...
      <div className="fixed bottom-50 md:bottom-64 right-6 md:right-8 z-50 flex items-center group">
        ...
        <a
          ...
          className="relative flex items-center justify-center w-14 h-14 bg-white border border-neutral-200 hover:border-neutral-300 rounded-full shadow-2xl transition-all duration-300 hover:scale-108 cursor-pointer z-10"
          aria-label="Write a Google review for Amazink Tattoo"
        >
          {/* Subtle Outer Pulsing Halo */}
          <span className="absolute -inset-1 border border-neutral-200 rounded-full animate-ping opacity-60 group-hover:animate-none"></span>
